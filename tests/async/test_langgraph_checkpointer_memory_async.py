...
class TestMemorySaver:
    ...
    def setup(self) -> None:
        memory = AsyncMemoryStore(AsyncInMemoryStorage())
        self.memory_saver = AsyncMemStateCheckpointer(memory=memory)
    ...
    async def test_asearch(self) -> None:
        ...
        search_results_5 = [
            c async for c in self.memory_saver.alist({"configurable": {"thread_id": "thread-2"}})
        ]
