# Tests from https://github.com/langchain-ai/langgraph/blob/main/libs/checkpoint/tests/test_memory.py
...
class TestMemorySaver:
    ...
    def setup(self) -> None:
        memory = MemoryStore(InMemoryStorage())
        self.memory_saver = MemStateCheckpointer(memory=memory)
    ...
    def test_combined_metadata(self) -> None:
        ...
        self.memory_saver.put(config, self.chkpnt_2, self.metadata_2, self.chkpnt_2["channel_versions"])
    ...
    def test_search(self) -> None:
        ...
        search_results_5 = list(self.memory_saver.list({"configurable": {"thread_id": "thread-2"}}))
